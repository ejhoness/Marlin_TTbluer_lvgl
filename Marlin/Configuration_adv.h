...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN  PB0         // Set a custom pin for the controller fan
  #define CONTROLLER_FAN_USE_Z_ONLY       // With this option only the Z axis is considered
  //#define CONTROLLER_FAN_IGNORE_X
  //#define CONTROLLER_FAN_IGNORE_Y
   #define CONTROLLER_FAN_IGNORE_Z
  //#define CONTROLLER_FAN_IGNORE_E0         // Ignore Z stepper. Useful when stepper timeout is disabled.
